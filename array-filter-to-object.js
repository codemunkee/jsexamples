...
const iceCreamTotals = data.reduce((accumulator, item) => {
  item.favoriteIceCreams.map((flavor) => {
    (accumulator[flavor] === undefined) ? accumulator[flavor] = 1 : accumulator[flavor] += 1
  })
  return accumulator
}, {});
